...
import torch
import platform
from util.download import download_all_data
from util.pytorch_misc import set_seed
...
class ModelConfig(object):
    ...
    def data_exists(self):
        return (self.split != 'gqa' and os.path.exists(os.path.join(self.data, 'VG', 'VG_100K')) ) \
               or (self.split == 'gqa' and os.path.exists(os.path.join(self.data, 'GQA', 'train_balanced_questions.json')))

    # and os.path.exists(os.path.join(self.data, 'VG', 'stanford_filtered')) 
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-data', dest='data', help='path where Visual Genome and GQA are located', type=str, default='/dataset/VQA/')
        ...
        parser.add_argument('-save_dir', dest='save_dir', help='Directory to save things to, such as checkpoints/save', default='checkpoints', type=str)
